    ...
    extends AboutActivity
{
    ...
    private void afterSetContentView_() {
        appTitle = ((TextView) findViewById(id.app_title_background));
    }
    ...
    public void updateTextColor() {
        handler_.post(new Runnable() {
            ...
            public void run() {
                try {
                    AboutActivity_.super.updateTextColor();
                } catch (RuntimeException e) {
                    Log.e("AboutActivity_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
    ...
    public void changeColors() {
        BackgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    AboutActivity_.super.changeColors();
                } catch (RuntimeException e) {
                    Log.e("AboutActivity_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
